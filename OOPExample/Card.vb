Public Class Card
    ...
    Private _suit As String '_suit is only accessible in this Class
    Public Property suit() As String 'suit
        Get
            Return _suit
        End Get
    ...
    Sub New(rank As String, suit As String)
        ...
        If Me.frontImage Is Nothing Then
            Me.frontImage = My.Resources.ResourceManager.GetObject($"blue_back")
        End If



        Me.backImage = My.Resources.Red_back
    End Sub
